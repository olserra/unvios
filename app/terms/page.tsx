  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="text-base text-muted-foreground mb-4">
        By using Unvios, you agree to these terms. Please read them carefully.
      </p>

      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">Acceptance of Terms</h2>
        <p className="text-sm text-muted-foreground">
          By accessing or using Unvios, you agree to be bound by these Terms of
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mb-2">
          Permission is granted to use Unvios for personal or commercial memory
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          You retain all rights to the memories and content you store in Unvios.
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          Unvios may use AI and machine learning to organize, search, and recall
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          We strive to keep Unvios available and functional, but we do not
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          Unvios is provided "as is" without any warranties, express or implied.
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          In no event shall Unvios or its suppliers be liable for any damages
          (including, without limitation, damages for loss of data or profit, or
          due to business interruption) arising out of the use or inability to
          use Unvios, even if we have been notified of the possibility of such
          damage.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          We may terminate or suspend your access to Unvios immediately, without
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          Continued use of Unvios after changes constitutes acceptance of the
          new terms.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          laws of the jurisdiction in which Unvios operates, without regard to
